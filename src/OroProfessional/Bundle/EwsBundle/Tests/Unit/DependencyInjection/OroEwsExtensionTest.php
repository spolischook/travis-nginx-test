...
namespace OroProfessional\Bundle\EwsBundle\Tests\Unit\DependencyInjection;

use OroProfessional\Bundle\EwsBundle\DependencyInjection\OroEwsExtension;
...
class OroEwsExtensionTest extends \PHPUnit_Framework_TestCase
{
    public function testLoad()
    {
        ...
        $bundle = $this->getMock('OroProfessional\Bundle\EwsBundle\OroProfessionalEwsBundle');
