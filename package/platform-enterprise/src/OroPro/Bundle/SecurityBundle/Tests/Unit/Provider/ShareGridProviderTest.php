...
namespace OroPro\Bundle\SecurityBundle\Tests\Unit\Provider;

use OroPro\Bundle\SecurityBundle\Provider\ShareGridProvider;
...
class ShareGridProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->shareScopeProvider = $this->getMockBuilder('OroPro\Bundle\SecurityBundle\Provider\ShareScopeProvider')
            ->disableOriginalConstructor()
            ->getMock();
