...
namespace OroB2BPro\Bundle\WebsiteConfigBundle\Controller;
...
class ConfigurationController extends Controller
{
    ...
    public function websiteConfigAction(
        ...
        $provider = $this->get('orob2bpro_website_config.provider.form_provider');
