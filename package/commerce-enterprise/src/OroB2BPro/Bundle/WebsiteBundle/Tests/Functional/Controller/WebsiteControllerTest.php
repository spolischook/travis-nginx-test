...
namespace OroB2BPro\Bundle\WebsiteBundle\Tests\Functional\Controller;
...
class WebsiteControllerTest extends WebTestCase
{
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('orob2bpro_website_index'));
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('orob2bpro_website_create'));
        $result = $this->client->getResponse();
        $this->assertHtmlResponseStatusCodeEquals($result, 200);
        ...
        $submittedData = [
            ...
            'orob2bpro_website_type' => [
                '_token' => $form['orob2bpro_website_type[_token]']->getValue(),
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('orob2bpro_website_update', ['id' => $id]));
        $html = $crawler->html();
