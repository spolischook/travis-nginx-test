...
namespace Oro\Bundle\PricingProBundle\Tests\Unit\Form\Extension;
...
use Oro\Bundle\PricingProBundle\EventListener\WebsiteListener;
use Oro\Bundle\PricingProBundle\Form\Extension\WebsiteFormExtension;
use Oro\Bundle\PricingProBundle\Tests\Unit\Form\Extension\Stub\WebsiteTypeStub;
...
class WebsiteFormExtensionTest extends FormIntegrationTestCase
{
    ...
    protected function getExtensions()
    {
        ...
        $listener = $this->getMockBuilder('Oro\Bundle\PricingProBundle\EventListener\WebsiteListener')
