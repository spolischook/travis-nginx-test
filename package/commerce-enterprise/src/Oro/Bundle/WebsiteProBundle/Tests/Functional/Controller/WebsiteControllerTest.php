...
namespace Oro\Bundle\WebsiteProBundle\Tests\Functional\Controller;
...
class WebsiteControllerTest extends WebTestCase
{
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('oro_websitepro_index'));
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('oro_websitepro_create'));
        $result = $this->client->getResponse();
        $this->assertHtmlResponseStatusCodeEquals($result, 200);
        ...
        $submittedData = [
            ...
            'oro_websitepro_type' => [
                '_token' => $form['oro_websitepro_type[_token]']->getValue(),
    ...
    {
        $crawler = $this->client->request('GET', $this->getUrl('oro_websitepro_update', ['id' => $id]));
        $html = $crawler->html();
