...
use Oro\Bundle\WebsiteProBundle\EventListener\FormViewListener;
...
class FormViewListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnViewNoRequest()
    {
        ...
        $this->environment
            ->expects($this->never())
            ->method('render')
            ->with('OroWebsiteProBundle::website_select.html.twig', ['form' => $this->event->getFormView()]);
    ...
    public function testOnEntityView()
    {
        ...
        $this->environment
            ...
            ->method('render')
            ->with(
                'OroWebsiteProBundle::website_field.html.twig',
